...
const text =
  'Mohammad Faisal is a Software Engineer & Manager at Optimizely.';
  ...
  return (
    <h1 className="jumbo" aria-label={text}>
      ...
      <span aria-hidden="true" className="prefers-animation">
        <Swapper before="Loading ..." after="Mohammad Faisal is a " onEnd={next} />
        <br />
        {state >= 1 && <Swapper before="{ %job }" after=" Software Engineer & Manager" onEnd={next} />}
        {state >= 2 && (
          <Type text=" at Optimizely." onEnd={() => setDone(true)} />
        )}
